...
.s-skin-hasbg .s-top-wrap {
	border: none;
	background: none;
	background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(15, 25, 50, .3
		)), to(rgba(15, 25, 50, .3)));
	background-image: -moz-linear-gradient(rgba(15, 25, 50, .3) 0,
		rgba(15, 25, 50, .3) 100%);
	background-image: -ms-linear-gradient(rgba(15, 25, 50, .3) 0,
		rgba(15, 25, 50, .3) 100%);
	background-image: -o-linear-gradient(rgba(15, 25, 50, .3) 0,
		rgba(15, 25, 50, .3) 100%);
	background-image: linear-gradient(rgba(15, 25, 50, .3) 0,
		rgba(15, 25, 50, .3) 100%);
	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=#330f1932,
...
#s_top_wrap.s-down .s-center-box {
	...
	background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(255, 255, 255,
		.95)), to(rgba(255, 255, 255, .95))) !important;
	background-image: -moz-linear-gradient(rgba(255, 255, 255, .95) 0,
		rgba(255, 255, 255, .95) 100%) !important;
	background-image: -ms-linear-gradient(rgba(255, 255, 255, .95) 0,
		rgba(255, 255, 255, .95) 100%) !important;
	background-image: -o-linear-gradient(rgba(255, 255, 255, .95) 0,
		rgba(255, 255, 255, .95) 100%) !important;
	background-image: linear-gradient(rgba(255, 255, 255, .95) 0,
		rgba(255, 255, 255, .95) 100%) !important;
	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=#f2ffffff,
		endColorstr=#f2ffffff) !important
}
...
.s-upfunc-menus .s-icons {
	float: left;
	_display: inline
}

.s-upfunc-menus .s-icons a {
	position: relative;
	height: 32px;
	line-height: 32px;
	margin-right: 19px;
...
.s-upfunc-menus .s-icons .hide-icon {
	display: none
}
...
#s_top_wrap.s-down #u_sp .hide-icon, #u_sp .s-icons .hide-icon {
	display: none
}
...
#u_sp .s-user-name-top, #u_sp .s-user-setting-top, #u_sp .s_bri {
	display: inline-block;
	*display: inline;
	zoom: 1;
	vertical-align: top;
...
#u_sp .s_briscrollwrapperContainer {
	position: relative
}

#u_sp .s_briscrollwrapper {
	overflow: hidden;
	position: relative
}

#u_sp .s_bdbriscroll-ctrl-scroll {
	position: absolute;
	top: 10px;
	right: 1px;
	width: 8px;
...
#u_sp .s_bdbriscroll-ctrl-scroll .s_bdbriscroll-axis {
	width: 8px;
	left: 0;
	z-index: 0;
	position: absolute;
...
#u_sp .s_bdbriscroll-ctrl-scroll .s_bdbriscroll-slider {
	overflow: hidden;
	width: 7px;
	height: 14px;
	position: absolute;
...
#u_sp .s_bdbriwrapper .s_bdbrievenmore {
	margin-top: 15px;
	height: 30px;
	width: 85px;
	overflow: hidden
...
#head_wrapper.s-down .fm, #head_wrapper.s-down #result_logo {
	display: inline-block;
	*display: inline;
	zoom: 1;
...
.s-skin-hasbg #s_lm_wrap {
	background: none;
	background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0.3)),
		to(rgba(0, 0, 0, 0.3)));
	background-image: -moz-linear-gradient(rgba(0, 0, 0, 0.3) 0,
		rgba(0, 0, 0, 0.3) 100%);
	background-image: -ms-linear-gradient(rgba(0, 0, 0, 0.3) 0,
		rgba(0, 0, 0, 0.3) 100%);
	background-image: -o-linear-gradient(rgba(0, 0, 0, 0.3) 0,
		rgba(0, 0, 0, 0.3) 100%);
...
#head_wrapper.s-down .btn:hover, #head_wrapper.s-down .btn.btnhover,
	.s-title-img .btn:hover, .s-title-img .btn.btnhover {
	height: 39px;
	_height: 38px;
...
.s-skin-hasbg .s-title-img .btn:hover {
	border-bottom: none;
	box-shadow: 1px 1px 3px rgba(0, 0, 0, 0.2);
	height: 40px
}

#head_wrapper.s-down .btn_h, .btn_h {
	padding: 0;
...
<link rel=stylesheet id=s_superplus_css_lnk type=text/css
	href="https://ss0.bdstatic.com/5aV1bjqh_Q23odCf/static/superman/css/super_min_c9c092d2.css">
<link rel=stylesheet type=text/css
	href="https://ss0.bdstatic.com/5aV1bjqh_Q23odCf/static/mancard/css/card_min_dee38e45.css">
<script>

window.sysTime=1522285556;
_manCard = {
	asynJs : [],
...
.bdsug-ala h3 {
	line-height: 14px;
	background: url(//www.baidu.com/img/sug_bd.png?v=09816787.png) no-repeat
		left center;
	margin: 6px 0 4px;
	font-size: 12px;
	font-weight: 400;
...
.bdsug .bdsug-pc-direct-tip {
	...
	display: block;
	background:
		url(https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/global/img/pc_direct_42d6311.png)
		no-repeat 0 0
}
...
.briiconsbg {
	...
	background-image:
		url(https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/home/img/icons_0c37e9b.png);
	background-image:
		url(https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/home/img/icons_809ae65.gif)
		\9
}
	...
	<div id=wrapper>
		...
		<div id=head class="">
			...
			<div id=s_upfunc_menus class=s-upfunc-menus>
				<div class=s-weather-wrapper>
					<div id=s_mod_weather
						class="s-mod-weather s-isindex-wrap hide-unknow-city ">
						<div class=weather-mod>
							<a class=city-wather
								href="//www.baidu.com/s?tn=baidutop10&rsv_idx=2&wd=%E5%8C%97%E4%BA%AC%E5%A4%A9%E6%B0%94%E9%A2%84%E6%8A%A5"
								target=_blank class=weather-mod-link>
								<div class=show-weather>
									<span class=show-city><em class=show-city-name
										data-key="北京"> 北京： </em></span><span class=show-icon><span
										class=weather-icon
										style="background-image: url(https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/icon/weather/aladdin/png_18/a0.png); *background-image: none; *filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src=https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/icon/weather/aladdin/png_18/a0.png, enabled=true, sizingMethod="=")" crop;></span><em
										class=show-icon-temp>15℃</em></span><span class=show-temp></span>
								</div>
								<div class="show-pollution ">
									<span class="show-airParm polution-level-20"><em
										class=show-polution-name>轻度</em><em class=show-polution-num>119</em></span><span
										class=show-vertical>|</span>
								</div>
							</a>
						</div>
						<div class=unknown-city>
							<span class=unknown-icon></span> <span class=unknown-text>查看天气信息，</span>
							<span class=unknown-setting>设置城市</span>
						</div>
					</div>
				</div>
				<div class="s-icons" id=s_icons>
					<a class=s-skin href="#" onclick="return false;" data-tid=2001
						title="换肤"><span class="s-icon s-icon-skin"></span><span
						class=title>换肤</span></a><a class=s-msg href="#"
						onclick="return false;" data-tid=2002 title="消息"><span
						class="s-icon s-icon-msg"></span><span class=title>消息</span></a><a
						class="s-lite hide-icon" href=/home/xman/show/liteoff target=_self
						title="显示频道"><span class="s-icon s-icon-lite"></span><span
						class=title>显示频道</span></a><em class="s-icon s-icon-line" href="#"
						onclick="return false;"></em>
					<div class=s-mod-msg-shadow id=s_mod_msg_shadow
						style="display: none;"></div>
					<div id=s_mod_msg class=s-mod-msg style="display: none;">
						<span class=menu-arrow> <em></em>
						</span>
						<div class=s-mod-msg-bg>
							<div class=msg-area id=s_msg_content></div>
						</div>
					</div>
					<div class=s-mod-treasure id=s_treasure style="display: none;"></div>
					<div class=s-opacity-tip id=s_opacity_tip style="display: none;"></div>
				</div>
			</div>
			<div id=u_sp class="s-isindex-wrap s-sp-menu">
				<a href=http://news.baidu.com target=_blank class=mnav>新闻</a> <a
					href=http://www.hao123.com target=_blank class=mnav>hao123</a> <a
					href=http://map.baidu.com target=_blank class=mnav>地图</a> <a
					href=http://v.baidu.com target=_blank class=mnav>视频</a> <a
					href=http://tieba.baidu.com target=_blank class=mnav>贴吧</a> <a
					href=http://xueshu.baidu.com target=_blank class=mnav>学术</a><a
					id=s_username_top class=s-user-name-top data-tid=2004
					href=http://i.baidu.com / target=_blank><span class=user-name>蓝若靛</span></a><a
					id=s_usersetting_top href="javascript:;" name=tj_settingicon
					class="pf s-user-setting-top"><span class=setting-text>设置</span></a><a
					href=http://www.baidu.com/more / name=tj_briicon class=s_bri
					target=_blank> 更多产品</a>
				<div id=s_user_name_menu
					class="s-isindex-wrap s-user-set-menu menu-top"
					style="display: none;">
					<div>
						<a href=http://i.baidu.com/center target=_blank data-tid=1000>
							个人中心 </a> <a href="http://passport.baidu.com/" data-tid=1001
							target=_blank> 帐号设置 </a> <a class=s-feedback
							style="overflow: hidden" href="#" onclick="return false;">意见反馈</a>
						<a class=quit style="overflow: hidden" href="#"
							onclick="return false;"> 退出 </a>
					</div>
					<span class=menu-arrow> <em></em>
					</span>
				</div>
				<div id=s_user_setting_menu
					class="s-isindex-wrap s-user-set-menu menu-top"
					style="display: none;">
					<div>
						<a href=//www.baidu.com/gaoji/preferences.html target=_blank>
							搜索设置 </a> <a href=//www.baidu.com/gaoji/advanced.html target=_blank>
							高级搜索 </a> <a href=http://i.baidu.com/my/history?from=index
							target=_blank> 搜索历史 </a> <a class=s-feedback
							style="overflow: hidden" href="#" onclick="return false;">
							意见反馈 </a>
					</div>
					<span class=menu-arrow> <em></em>
					</span>
				...
				<div id=s_fm class=s_form>
					<div class=s_form_wrapper id=s_form_wrapper>
						<div id=lg class=s-p-top>
							<img id=s_lg_img
								src="//www.baidu.com/img/bd_logo1.png?where=super" width=270
								height=129 usemap="#mp">
							<map name=mp id=s_mp>
								<area style="cursor: pointer; outline: none;" shape=rect
									coords="0,0,270,129"
									href="//www.baidu.com/s?wd=%E4%BB%8A%E6%97%A5%E6%96%B0%E9%B2%9C%E4%BA%8B&tn=SE_Pclogo_6ysd4c7a&sa=ire_dl_gh_logo&rsv_dl=igh_logo_pc"
									target=_blank style="outline:none;" title="点击一下，了解更多"
						...
						<form name=f id=form action=/s class=fm
							...
							<span id=s_kw_wrap class="bg s_ipt_wr"><input type=text
								class=s_ipt name=wd id=kw maxlength=100 autocomplete=off></span><input
								type=hidden name=rsv_spt value=1><input type=hidden
								name=rsv_iqid value="0xac31dc8a0002ffca"><input
								type=hidden name=issp value=1><input type=hidden name=f
								value=8><input type=hidden name=rsv_bp value=0><input
								type=hidden name=rsv_idx value=2><input type=hidden
								name=ie value=utf-8><input type=hidden name=rqlang
								value=""><input type=hidden name=tn value="baiduhome_pg"><input
								type=hidden name=ch value=""><span
								class="btn_wr s_btn_wr bg" id=s_btn_wr><input type=submit
								value="百度一下" id=su class="btn self-btn bg s_btn"></span><span
								class=tools><span id=mHolder><div id=mCon>
										<span>输入法</span>
									</div>
									<ul id=mMenu>
										<li><a href="javascript:;" name=ime_hw>手写</a>
										<li><a href="javascript:;" name=ime_py>拼音</a>
										<li class=ln>
										<li><a href="javascript:;" name=ime_cl>关闭</a>
									</ul></span><span class=bd_bear_home></span></span>
						</form>
					</div>
				</div>
				<div id=u>
					<a class=toindex href= />百度首页</a><span class=toindex></span><a id=imsg
						href="http://www.baidu.com/#"
						onmousedown="return user_c({'fm':'set','tab':'imsg','login':'1'})">消息</a><a
						href="javascript:;" name=tj_settingicon class=pf>设置<i
						class="c-icon c-icon-triangle-down"></i></a><a href=http://i.baidu.com
						id=user class=username>蓝若靛<i class=c-icon></i></a>
				</div>
				<div id=s_lm_wrap class="s_lm_hide s-isindex-wrap">
					<div id=lm></div>
				</div>
						...
						<div class=s-menu-container>
							<div id=s_menu_gurd class=s-menu-gurd>
								<div id=s_ctner_menus class="s-ctner-menus s-opacity-blank8">
									<span id=s_menu_mine
										class="s-menu-item s-menu-mine s-opacity-white-background"
										data-id=100><div class=mine-icon></div>
										<div class=mine-text>我的关注</div></span>
									<div class=s-menus-outer>
										<div id=s_menus_wrapper class=menus-wrapper>
											<span class="s-menu-item s-opacity-white-background current"
												data-id="2"> 推荐 </span><span
												class="s-menu-item s-opacity-white-background" data-id="1">
												导航 </span>
										</div>
										<div class="s-bg-space s-opacity-white-background"></div>
									</div>
									<span id=s_menu_set
										class="s-menu-setting s-opacity-white-background" data-id=99
										title="设置"><div class=menu-icon></div></span>
								</div>
							</div>
						</div>
						<div id=s_ctner_contents
							class="s-ctner-contents s-opacity-white-background">
							<div id="s_content_2" class=s-content data-id="2">
								<script>window._card_aync = 1;</script>
								<div id="s_content_2" class=s-content>
									<div class="s-content-load s-opacity-white-background">
										<img
											src="https://ss0.bdstatic.com/5aV1bjqh_Q23odCf/static/mancard/img/loading_deadaef0.gif">
										<div>加载中，精彩马上呈现</div>
									</div>
								</div>
							</div>
						</div>
						<div class=s-more-bar style="visibility: hidden">
							<div class=load-text>滚动查看更多</div>
							<div class=rect>
								<div class=animate-arrow></div>
							</div>
						</div>
						<textarea id="s_menus_textarea" style="display: none;">{"data": [{"id": 2,"name": "推荐","state": "1","ismenu": "1"},{"id": 1,"name": "导航","state": "1","ismenu": "1"},{"id": 100,"name": "我的关注","state": "1","ismenu": "0"},{"id": 23,"name": "体育","state": "","ismenu": "1"},{"id": 20,"name": "小说","state": "","ismenu": "1"},{"id": 3,"name": "音乐","state": "","ismenu": "1"}],"isEnd": "","illegal": ""}</textarea>
						<div id=s_top_feed class="top-feed">
							<div class=to-top data-tool=1 style="visibility: hidden;">
								<div class=icon-mask>
            ...
            window._xman_speed && _xman_speed.imgLoadTime(2);
				...
				<textarea id="s_sync_data" style="display: none;">
        
    </textarea>
			</div>
			<div id=bottom_container class=s-bottom-ctner>
				<div class="ftCon-Wrapper">
					...
					<div class=no-qrcode-layer>
						<div>
							<p class=lh>
								<a class=sethome href=//www.baidu.com/cache/sethelp/index.html
									target=_blank> 设为首页 </a>
							</p>
							<span class=copyright-text><span>&#169;2018&nbsp;Baidu&nbsp;</span><a
								href=//www.baidu.com/duty / target=_blank>使用百度前必读</a>&nbsp;<a
								href=http://jianyi.baidu.com target=_blank>意见反馈</a>&nbsp;<span>京ICP证030173号&nbsp;</span><img
								width=13 height=16
			...
			<div class="s-newmusic s-isindex-wrap" id=s_mancard_newmusic
				style="display: none;">
				<div class="p-panel clearfix" id=p_panel>
					<div class=p-main-wrapper>
						<div class="p-img js-p-img">
							<a class=cur-img target=_blank><img height=50px width=50px
								src="https://ss0.bdstatic.com/5aV1bjqh_Q23odCf/static/newmusic/img/default_8a5b42b2.png"></a>
						</div>
						<div class=p-main-area>
							<div class=p-main>
								<div class=p-music-info>
									<div class=p-chanel>
										<span class="p-chanel-btn js-change-sence"><span
											class=change-bg></span><span
											class="p-chanel-txt js-chanel-name"></span></span>
									</div>
									<div class=p-songinfo>
										<div class=p-songinfo-scroll>
											<span class=song-name></span><span class=sep>-</span><span
												class=song-artist></span>
										</div>
									</div>
								</div>
								<div class="control-btn clearfix" style="float: left;">
									<div class="common-music-btn icon-pic p-prev-btn js-play-prev"
										title="上一首"></div>
									<div
										class="common-music-btn icon-pic p-status js-play-pause icon-play-pause icon-play-playing"></div>
									<div class="common-music-btn icon-pic p-next-btn js-play-next"
										title="下一首"></div>
									<div
										class="common-music-btn icon-pic p-switch-btn icon-play-mode-normal js-switch-mode"
										title="循环播放"></div>
									<div class="js-scroll-wrapper p-progress-wrapper">
										<div class="p-progress js-scroll-root hide-icon">
											<div class="past js-scroll-indicator">
												<span class="icon-pic progress-icon js-scroll-ctrl"></span>
											</div>
										</div>
									</div>
									<div class=time-total>00:00</div>
									<div
										class="common-music-btn other-btn icon-pic p-collect-btn icon-song-collect js-song-collect"
										title="收藏"></div>
									<div
										class="common-music-btn other-btn icon-pic lrc-btn js-song-lrc"
										title="歌词"></div>
									<div class="p-volume-wrapper js-volume-hover clearfix">
										<div class=p-volume-bg>
											<div class="p-volume-line js-volume-line">
												<div class="p-volume js-scroll-root">
													<div class="past js-scroll-indicator">
														<a class="icon-pic progress-icon js-scroll-ctrl"
															style="display: none;"></a>
													</div>
												</div>
											</div>
											<div
												class="common-music-btn other-btn icon-pic p-volume-btn js-volume-onoff icon-volume-on"
												title="音量"></div>
										</div>
									</div>
									<div class="p-more-wrapper js-more-hover">
										<div class=p-more-panel>
											<ul>
												<li class=js-delete-song>
													<div class="common-music-btn icon-pic p-delete-btn "
														title="删除"></div> <span class=text>删除</span>
												<li class=js-song-share>
													<div class="common-music-btn icon-pic p-share-btn"
														title="分享"></div> <span class=text>分享</span>
													<div class=share-panel-wrapper id=share_panel>
														<div class=share-body>
															<a href="###" target=_blank data-type=tsina
																class=share-icons-tsina></a> <a href="###" target=_blank
																data-type=tqq class=share-icons-tqq></a> <a href="###"
																target=_blank data-type=qzone class=share-icons-qzone></a>
															<a href="###" target=_blank data-type=sqq
																class=share-icons-sqq></a> <a href="###" target=_blank
																data-type=tieba class=share-icons-tieba></a>
														</div>
										...
										<div class="common-music-btn other-btn icon-pic p-more-btn"
											title="更多"></div>
									</div>
								</div>
								<div class=p-close-bg></div>
								<div
									class="common-music-btn icon-pic p-close-btn js-player-close down"
									title="收起"></div>
							</div>
						</div>
					</div>
				...
				<div class=result-tips-wrapper>
					<div class=result-tips-area>
						<span class=icon-pic></span>
						<p>歌曲加载失败</p>
					</div>
				</div>
				<div class="s-panel js-panel" id=s_panel>
					<div class=s-panel-bg></div>
					<div class=s-panel-wrapper>
						<div class="head clearfix">
							<p class=title>
								推荐电台(<span class=count>48</span>)
							</p>
							<p class=mylike>
								<a class=js-formy
									href="http://play.baidu.com/?__t=list_allfavor&from=bd_card"
									target=_blank>我的收藏 (<span class="like-count js-like-count"></span>)
								</a>
							</p>
						</div>
						<div class="s-list-wrapper clearfix slider-wrapper">
							<div class="prev-page-btn control-left" title="上一页">
								<span class="icon-pic prev-page-icon"></span>
							</div>
							<div class="next-page-btn control-right" title="下一页">
								<span class="icon-pic next-page-icon"></span>
							</div>
							<div style="position: relative; overflow: hidden; width: 100%;">
								<div style="position: relative; left: 0px; width: 60000px;"
									class="clearfix mui-slider-scroll-container">
									<ul class="s-list clearfix" data-index="0"">
										<li data-id="public_tuijian_suibiantingting" data-type="other"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/suibiantingting.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>随便听听</div>
										<li data-id="lovesongs" data-type="other"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/lovesong.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>红心频道</div>
										<li data-id="public_tuijian_chengmingqu" data-type="other"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss1.bdstatic.com/kvoZeXSm1A5BphGlnYG/newmusic/chengmingqu.png?v=md5">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>成名曲</div>
										<li data-id="public_shiguang_jingdianlaoge" data-type="other"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss1.bdstatic.com/kvoZeXSm1A5BphGlnYG/newmusic/jingdianlaoge.png?v=md5">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>经典老歌</div>
										<li data-id="public_tuijian_yingshi" data-type="other"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss1.bdstatic.com/kvoZeXSm1A5BphGlnYG/newmusic/yingshi.png?v=md5">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>影视</div>
										<li data-id="public_fengge_qingyinyue" data-type="other"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss1.bdstatic.com/kvoZeXSm1A5BphGlnYG/newmusic/qingyinyue.png?v=md5">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>轻音乐</div>
										<li data-id="public_xinqing_qingge" data-type="other"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss1.bdstatic.com/kvoZeXSm1A5BphGlnYG/newmusic/danshen.png?v=md5">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>单身情歌</div>
										<li data-id="156" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss1.bdstatic.com/kvoZeXSm1A5BphGlnYG/newmusic/wangluogequ.png?v=md5">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>网络歌曲</div>
										<li data-id="42" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/chinese.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>国语</div>
									</ul>
									<ul class="s-list clearfix" data-index="1"">
										<li data-id="71" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss1.bdstatic.com/kvoZeXSm1A5BphGlnYG/newmusic/2000nian.png?v=md5">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>2000年代</div>
										<li data-id="public_fengge_yaogun" data-type="other"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss1.bdstatic.com/kvoZeXSm1A5BphGlnYG/newmusic/yaogun.png?v=md5">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>摇滚</div>
										<li data-id="44" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/english.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>英文</div>
										<li data-id="public_tuijian_ktv" data-type="other"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss1.bdstatic.com/kvoZeXSm1A5BphGlnYG/newmusic/KTV.png?v=md5">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>KTV金曲</div>
										<li data-id="public_shiguang_90hou" data-type="other"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss1.bdstatic.com/kvoZeXSm1A5BphGlnYG/newmusic/90.png?v=md5">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>90后</div>
										<li data-id="public_fengge_zhongguofeng" data-type="other"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss1.bdstatic.com/kvoZeXSm1A5BphGlnYG/newmusic/zhongguofeng.png?v=md5">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>中国风</div>
										<li data-id="public_shiguang_80hou" data-type="other"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss1.bdstatic.com/kvoZeXSm1A5BphGlnYG/newmusic/80.png?v=md5">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>80后</div>
										<li data-id="public_fengge_xiaoqingxin" data-type="other"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss1.bdstatic.com/kvoZeXSm1A5BphGlnYG/newmusic/xiaoqingxin.png?v=md5">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>小清新</div>
										<li data-id="public_yuzhong_hanyu" data-type="other"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss1.bdstatic.com/kvoZeXSm1A5BphGlnYG/newmusic/hanyu.png?v=md5">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>韩语</div>
									</ul>
									<ul class="s-list clearfix" data-index="2"">
										<li data-id="public_fengge_dj" data-type="other"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss1.bdstatic.com/kvoZeXSm1A5BphGlnYG/newmusic/DJ.png?v=md5">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>DJ舞曲</div>
										<li data-id="10" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/single.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>独处</div>
										<li data-id="5" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/morining.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>清晨</div>
										<li data-id="40" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/relax.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>轻松时刻</div>
										<li data-id="15" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/afternoon.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>慵懒午后</div>
										<li data-id="33" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/newsong.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>新歌试听</div>
										<li data-id="38" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/happy.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>欢乐旋律</div>
										<li data-id="41" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/miss.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>思念</div>
										<li data-id="37" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/zhiyu.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>治愈系</div>
									</ul>
									<ul class="s-list clearfix" data-index="3"">
										<li data-id="81" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/slience.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>安静</div>
										<li data-id="36" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/sad.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>伤感</div>
										<li data-id="35" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/lonly.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>寂寞电波</div>
										<li data-id="43" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/yueyu.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>粤语</div>
										<li data-id="39" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/zuile.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>醉了</div>
										<li data-id="9" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/sleep.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>睡眠</div>
										<li data-id="16" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/study.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>学习</div>
										<li data-id="1" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/sport.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>运动</div>
										<li data-id="13" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/evening.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>傍晚</div>
									</ul>
									<ul class="s-list clearfix" data-index="4"">
										<li data-id="12" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/work.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>工作</div>
										<li data-id="48" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/pop.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>流行风</div>
										<li data-id="31" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/household.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>家务</div>
										<li data-id="23" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/coffee.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>咖啡时光</div>
										<li data-id="28" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/home.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>宅</div>
										<li data-id="2" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/party.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>聚会</div>
										<li data-id="29" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/net.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>上网</div>
										<li data-id="21" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/haichuang.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>赖床</div>
										<li data-id="20" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/wake.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>懒洋洋</div>
									</ul>
									<ul class="s-list clearfix" data-index="5"">
										<li data-id="34" data-type="" class="s-item js-play-songlist">
											<span class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/jidong.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>活力四射</div>
										<li data-id="26" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/son.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>亲子时光</div>
										<li data-id="30" data-type="default"
											class="s-item js-play-songlist"><span
											class=sence-block-hover></span> <span
											href="javascript:void(0);" class=sence-block> <img
												width=70px height=70px
												data-src="https://ss0.bdstatic.com/k4oZeXSm1A5BphGlnYG/newmusic/yujia.png">
										</span>
											<div class="icon-pic s-play-btn js-splay-btn"></div>
											<div class="icon-pic s-playing-wrapper"></div>
											<div class=desc>瑜伽</div>
									</ul>
								</div>
							</div>
						</div>
					</div>
					<span class="icon-pic close-btn js-sence-close" title="关闭"></span>
				</div>
				<div class=l-panel-wrapper id=lyc_panel>
					<div class=l-panel-bg></div>
					<div class=l-panel-area data-tid=7777>
						<div class=lyc-wrapper>
							<div class=l-panel id=s_mancard_newmusic_playingLrc></div>
						</div>
						<div class=l-header>
							<div class="icon-pic close-btn js-lyc-close" title="关闭"></div>
						</div>
					</div>
				</div>
				<div class="p-sidebar js-player-open">
					<div class=bar-bg data-tid=7778></div>
					<div class=bar-mask></div>
					<span class=bar-text>音乐</span> <span class=bar-playing
						style="display: none;"></span>
				</div>
				<link rel=stylesheet type=text/css
					href="https://ss0.bdstatic.com/5aV1bjqh_Q23odCf/static/newmusic/css/newmusic_min_0048b8c6.css">
				<script id=s_js_newmusic
					data-src="https://ss0.bdstatic.com/5aV1bjqh_Q23odCf/static/newmusic/js/newmusic_min_35dd219a.js">
    _manCard.asynLoad("s_js_newmusic");
		...
		<div class=s_tab id=s_tab>
			<b>网页</b><a
				...
				wdfield=word onmousedown="return c({'fm':'tab','tab':'news'})">新闻</a><a
				...
				wdfield=word onmousedown="return c({'fm':'tab','tab':'zhidao'})">知道</a><a
				href="http://music.baidu.com/search?fr=ps&amp;key=" wdfield=key
				onmousedown="return c({'fm':'tab','tab':'music'})">音乐</a><a
				href="http://image.baidu.com/i?tn=baiduimage&amp;ps=1&amp;ct=201326592&amp;lm=-1&amp;cl=2&amp;nc=1&amp;word="
				wdfield=word onmousedown="return c({'fm':'tab','tab':'pic'})">图片</a><a
				href="http://v.baidu.com/v?ct=301989888&amp;rn=20&amp;pn=0&amp;db=0&amp;s=25&amp;word="
				wdfield=word onmousedown="return c({'fm':'tab','tab':'video'})">视频</a><a
...
(function(){
    ...
    bds.comm.indexSid="1439_21086_20719";
    bds.comm.queryId="ac31dc8a0002ffca";
        bds.comm.pdc=0;
        bds.comm.user="蓝若靛";
	...
	<script
		src="https://ss0.bdstatic.com/5aV1bjqh_Q23odCf/static/superman/js/sbase_f1d73ac3.js"></script>
	<style type="text/css">
